...
public sealed class PgmCommandResult
{
    ...
    public static PgmCommandResult Ok(bool estadoConfirmado, CentralStatusResponse statusResultante) =>
...
/// manualmente com os dois comandos oficiais. Portado de Integra-o-FL-main/SDK/CentralHub.SDK
/// (Sprint 12 — ADR 0014/0015).
/// </summary>
/// <remarks>
...
public sealed class PgmCommandService
{
        ...
        string numeroSerie, JflCommand cmd, int pgmNumero, bool estadoEsperado, CancellationToken cancellationToken, TimeSpan? timeout)
    {
        ...
        try
        {
            ...
            return confirmado
                ? PgmCommandResult.Ok(pgm!.Acionada, status)
